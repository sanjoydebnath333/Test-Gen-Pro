...
"bengali": {
        ...
        title: "Bengali (বাংলা)",
        icon: "📖",
        theme: "#f97316", // Orange theme for Bengali
        gradient: "linear-gradient(135deg, #f97316, #eab308)",
        sections: [
            { id: 'mcq_standard', title: 'সঠিক উত্তরটি নির্বাচন করো', max: 20, default: 10, marksPerQ: 1 },
            { id: 'one_word', title: 'এক কথায় উত্তর দাও', max: 15, default: 5, marksPerQ: 1 },
            { id: 'fill_blanks', title: 'শূন্যস্থান পূরণ করো', max: 15, default: 5, marksPerQ: 1 },
            { id: 'true_false', title: 'হ্যাঁ অথবা না লেখো', max: 15, default: 5, marksPerQ: 1 },
            { id: 'word_meaning', title: 'শব্দার্থ লেখো', max: 10, default: 5, marksPerQ: 1 },
            { id: 'opposite_word', title: 'বিপরীত শব্দ লেখো', max: 10, default: 5, marksPerQ: 1 }
        ],
        bank: {
            mcq_standard: [
                // Chapter-1: স্বাধীনতার সুখ (কবিতা)
                { q: "বাবুই পাখি বাসা বাঁধে নারকেল গাছের—", a: "পাতায়", options: ["পাতায়", "ডালে", "কোটরে", "গোড়ায়"] },
                { q: "কবিতায় নিজের ঘর নিয়ে কে অহংকার করছে?—", a: "চড়াই পাখি", options: ["চড়াই পাখি", "বাবুই পাখি", "কাক", "কোকিল"] },
                
                // Chapter-2: বোকামির ফল (গল্প)
                { q: "ঘন বনটি ছিল পাহাড়ের—", a: "তলায়", options: ["তলায়", "ওপরে", "পাশে", "গুহায়"] },
                { q: "পুকুরের জল ছিল—", a: "পরিষ্কার ও শীতল", options: ["পরিষ্কার ও শীতল", "নোংরা ও গরম", "কর্দমাক্ত", "শুধু শীতল"] },
                { q: "কচ্ছপের বিপদ হয়েছিল, কারণ সে—", a: "মুখ খুলেছিল", options: ["মুখ খুলেছিল", "হাঁসদের বিশ্বাস করেনি", "নিচে দেখতে গিয়েছিল", "লাঠি ছেড়েছিল"] },
                { q: "কম্বুগ্রীব কামড়ে ধরেছিল—", a: "লাঠির মাঝখানটা", options: ["লাঠির মাঝখানটা", "লাঠির প্রান্ত", "হাঁসের পা", "হাঁসের ডানা"] },
                
                // Chapter-4: দয়ার সাগর (গল্প)
                { q: "মহিলাটির কোলে ছিল—", a: "মৃতপ্রায় শিশু", options: ["মৃতপ্রায় শিশু", "ফুটফুটে শিশু", "মৃত শিশু", "সুস্থ শিশু"] },
                { q: "মহিলা ভিক্ষা চাইছিল—", a: "শিশুর চিকিৎসার জন্য", options: ["শিশুর চিকিৎসার জন্য", "খাবার কেনার জন্য", "জামা-কাপড় কেনার জন্য", "বাড়ি ফেরার জন্য"] }
            ],
            one_word: [
                // Chapter-1: স্বাধীনতার সুখ (কবিতা)
                { q: "'স্বাধীনতা' কথাটির অর্থ কী?", a: "মুক্তজীবন", options: ["মুক্তজীবন", "পরাধীনতা", "বন্দী জীবন", "কষ্টের জীবন"] },
                { q: "কে কুঁড়ে ঘরে থাকে?", a: "বাবুই পাখি", options: ["বাবুই পাখি", "চড়াই পাখি", "কাক", "শালিক"] },
                { q: "'কষ্ট পাই'— কে কষ্ট পায়?", a: "বাবুই পাখি", options: ["বাবুই পাখি", "চড়াই পাখি", "পায়রা", "কোকিল"] },
                { q: "কে অট্টালিকায় থাকে?", a: "চড়াই পাখি", options: ["চড়াই পাখি", "বাবুই পাখি", "ময়ূর", "টিয়া"] },
                { q: "বাবুই পাখি ও চড়াই পাখির মধ্যে কে স্বাধীন?", a: "বাবুই পাখি", options: ["বাবুই পাখি", "চড়াই পাখি", "দুজনেই", "কেউই নয়"] },
                { q: "কার বাসা খাসা?", a: "বাবুই পাখির", options: ["বাবুই পাখির", "চড়াই পাখির", "কাকের", "শালিকের"] },
                
                // Chapter-2: বোকামির ফল (গল্প)
                { q: "পুকুরে কী ফুল ফুটে থাকত?", a: "পদ্মফুল", options: ["পদ্মফুল", "গোলাপ", "জবা", "শাপলা"] },
                { q: "কোন ঋতুতে পুকুর, নদী, নালা সব শুকিয়ে গিয়েছিল?", a: "গ্রীষ্মকালে", options: ["গ্রীষ্মকালে", "শীতকালে", "বর্ষাকালে", "শরৎকালে"] },
                { q: "হাঁসেরা লাঠিটি কোথায় চেপে ধরেছিল?", a: "ঠোঁটের মধ্যে", options: ["ঠোঁটের মধ্যে", "ডানার মধ্যে", "পায়ের মধ্যে", "গলার মধ্যে"] },
                { q: "কচ্ছপকে উড়ে যেতে দেখে কারা চিৎকার করছিল?", a: "গ্রামের একদল ছেলে", options: ["গ্রামের একদল ছেলে", "হাঁসেরা", "চাষীরা", "পাখিরা"] },
                { q: "কচ্ছপটির নাম কী ছিল?", a: "কম্বুগ্রীব", options: ["কম্বুগ্রীব", "শুভ্রগ্রীব", "নীলগ্রীব", "তাম্রগ্রীব"] },
                { q: "পাহাড়ের তলায় কী ছিল?", a: "ঘন বন", options: ["ঘন বন", "নদী", "গ্রাম", "প্রান্তর"] },
                { q: "\"ব্যাটারা ছাই খা\" কে বলেছিল?", a: "কচ্ছপটি", options: ["কচ্ছপটি", "হাঁসেরা", "ছেলেরা", "শিকারি"] },
                { q: "সেই পুকুরটিতে রোজ কারা এসে সাঁতার কাটত?", a: "দুটি রাজহাঁস", options: ["দুটি রাজহাঁস", "দুটি ব্যাঙ", "দুটি মাছ", "দুটি সাপ"] },
                
                // Chapter-3: প্রার্থনা (কবিতা)
                { q: "শিশুটি সারাদিন কেমন ভাবে চলতে চায়?", a: "ভালো ছেলে হয়ে", options: ["ভালো ছেলে হয়ে", "দুষ্টু ছেলে হয়ে", "সারাদিন খেলে", "ঘুমিয়ে কাটাতে চায়"] },
                { q: "'মিথ্যা' কথা বলতে নেই কেন?", a: "'মিথ্যা' বলা মহাপাপ", options: ["'মিথ্যা' বলা মহাপাপ", "কেউ ভালোবাসে না", "মার খাবে", "কেউ শুনবে না"] },
                { q: "শিশুটি কাদের সাথে খেলা করতে চায়?", a: "ভালো ছেলেদের সাথে", options: ["ভালো ছেলেদের সাথে", "দুষ্টু ছেলেদের সাথে", "একা একা", "বড়দের সাথে"] },
                { q: "শিশুটি মুখে কী আনতে চায় না?", a: "মিথ্যে কথা", options: ["মিথ্যে কথা", "সত্যি কথা", "খারাপ কথা", "গান"] },
                { q: "শিশুটি কোন কাজে হেলা করবে না?", a: "পড়াশোনায়", options: ["পড়াশোনায়", "খেলাধুলায়", "ঘুমানোয়", "গল্প করায়"] },
                
                // Chapter-4: দয়ার সাগর (গল্প)
                { q: "'বিদ্যাসাগরের' আসল নাম কী?", a: "ঈশ্বরচন্দ্র বন্দ্যোপাধ্যায়", options: ["ঈশ্বরচন্দ্র বন্দ্যোপাধ্যায়", "সুভাষচন্দ্র বসু", "রবীন্দ্রনাথ ঠাকুর", "বঙ্কিমচন্দ্র চট্টোপাধ্যায়"] },
                { q: "'রাজপথ' কাকে বলে?", a: "মুখ্য বা প্রধান সড়ককে", options: ["মুখ্য বা প্রধান সড়ককে", "রাজার বাড়িকে", "গ্রামের পথকে", "বনের পথকে"] },
                { q: "ঈশ্বরচন্দ্রকে কী নামে ডাকা হতো?", a: "দয়ার সাগর", options: ["দয়ার সাগর", "বিদ্যা নিধি", "করুণা সিন্ধু", "মহাপুরুষ"] },
                { q: "কী দেখে তাঁর মন করুণায় ভরে গেল?", a: "শিশুটির অবস্থা দেখে", options: ["শিশুটির অবস্থা দেখে", "মহিলার কান্না দেখে", "পথের ভিড় দেখে", "পাখির কষ্ট দেখে"] },
                { q: "মহিলাটি কার কাছে ভিক্ষা চাইছিল?", a: "পথচলতি মানুষের কাছে", options: ["পথচলতি মানুষের কাছে", "রাজার কাছে", "বিদ্যাসাগরের কাছে", "ডাক্তারের কাছে"] },
                { q: "শিশুটি মৃতপ্রায় কেন?", a: "মারাত্মক রোগে আক্রান্ত তাই", options: ["মারাত্মক রোগে আক্রান্ত তাই", "খেতে পায়নি তাই", "জল পায়নি তাই", "পথ হারিয়েছে তাই"] },
                { q: "ডাক্তার কে ডেকে এনেছিলেন?", a: "বিদ্যাসাগর মহাশয়", options: ["বিদ্যাসাগর মহাশয়", "একজন ভদ্রলোক", "একজন ছাত্র", "পথচলতি মানুষ"] }
            ],
            fill_blanks: [
                // Chapter-1: স্বাধীনতার সুখ (কবিতা)
                { q: "কষ্ট পাই তবু থাকি নিজের ⾕ ___।", a: "বাসায়", options: ["বাসায়", "ঘরে", "গাছে", "ডালে"] },
                { q: "আমি থাকি মহাসুখে 🏫___ পরে।", a: "অট্টালিকার", options: ["অট্টালিকার", "গাছের", "কুঁড়েঘরের", "পাহাড়ের"] },
                
                // Chapter-2: বোকামির ফল (গল্প)
                { q: "পাহাড়ের তলায় ___ ছিল।", a: "ঘনবন", options: ["ঘনবন", "গ্রাম", "পুকুর", "নদী"] },
                { q: "সে বছর গ্রীষ্মকালে একটুও ___ হলো না।", a: "বৃষ্টি", options: ["বৃষ্টি", "রোদ", "হাওয়া", "মেঘ"] },
                { q: "'আমি তো ___ অভাবে শুকিয়ে মারা যাব'।", a: "জলের", options: ["জলের", "খাবারের", "বৃষ্টির", "হাওয়ার"] },
                { q: "'বন্ধু উড়ে যাওয়ার সময় ভুলেও ___ বলবে না'।", a: "কথা", options: ["কথা", "গান", "শব্দ", "গল্প"] },
                { q: "সে চেঁচিয়ে বলতে গেল ___।", a: "'ব্যাটারা ছাই খা'", options: ["'ব্যাটারা ছাই খা'", "'তোরা বোকা'", "'আমি উড়ছি'", "'তোরা থাম'"] },
                { q: "___ মরণ এরকম ভাবেই হয়।", a: "বোকাদের", options: ["বোকাদের", "চালাকদের", "পাখিদের", "কচ্ছপদের"] },
                { q: "পুকুরে ___ ফুল ফুটে থাকত।", a: "পদ্ম", options: ["পদ্ম", "শাপলা", "জবা", "গোলাপ"] },
                { q: "হাঁসেরা লাঠি ___ চেপে ধরেছিল।", a: "ঠোঁটে", options: ["ঠোঁটে", "পায়ে", "ডানায়", "মাথায়"] },
                
                // Chapter-3: প্রার্থনা (কবিতা)
                { q: "___ যেন নাহি হই আমি কারোও দুখে।", a: "সুখী", options: ["সুখী", "অসুখী", "দুঃখী", "আনন্দিত"] },
                { q: "___ না করি যেন কভু কারও সনে।", a: "ঝগড়া", options: ["ঝগড়া", "মারামারি", "খেলা", "বন্ধুত্ব"] },
                { q: "কিছুতে কাহারে যেন নাহি দিই ___।", a: "ফাঁকি", options: ["ফাঁকি", "দুঃখ", "কষ্ট", "লজ্জা"] },
                { q: "___ করেন যাহা মোর গুরুজনে।", a: "আদেশ", options: ["আদেশ", "নির্দেশ", "বারণ", "প্রার্থনা"] },
                
                // বিবিধ (Mixed)
                { q: "বনের ধারে একটা বড় ___ ছিল।", a: "জামগাছ", options: ["জামগাছ", "আমগাছ", "বটগাছ", "নারকেল গাছ"] },
                { q: "যথা সময়ে ___ ফুটে চারটি বাচ্চা বেরোল।", a: "ডিম", options: ["ডিম", "ফুল", "ফল", "কুঁড়ি"] },
                { q: "শিউলি ফুল ফুটলে ___ আসে।", a: "দুর্গাপূজা", options: ["দুর্গাপূজা", "কালীপূজা", "সরস্বতী পূজা", "দোলযাত্রা"] }
            ],
            true_false: [
                // Chapter-1: স্বাধীনতার সুখ (কবিতা)
                { q: "বাবুই পাখির বাসাকে শিল্পকর্ম বলা যায়।", a: "হ্যাঁ", options: ["হ্যাঁ", "না"] },
                { q: "বাবুই পাখি ও চড়াই পাখি উভয়ই স্বাধীন।", a: "না", options: ["হ্যাঁ", "না"] },
                
                // Chapter-2: বোকামির ফল (গল্প)
                { q: "সেই পুকুরে বাস করত এক কচ্ছপ।", a: "হ্যাঁ", options: ["হ্যাঁ", "না"] },
                { q: "হাঁসদের সাথে কচ্ছপের খুব বন্ধুত্ব হয়েছিল।", a: "হ্যাঁ", options: ["হ্যাঁ", "না"] },
                
                // Chapter-3: প্রার্থনা (কবিতা)
                { q: "শিশুটি মানতে চায় গুরুজনের আদেশ।", a: "হ্যাঁ", options: ["হ্যাঁ", "না"] },
                
                // Chapter-4: দয়ার সাগর (গল্প)
                { q: "ডাক্তার ডেকে এনেছিল একজন ভদ্রলোক।", a: "না", options: ["হ্যাঁ", "না"] },
                { q: "শিশুটিকে দেখে বিদ্যাসাগরের খুব দয়া হলো।", a: "হ্যাঁ", options: ["হ্যাঁ", "না"] },
                { q: "বিদ্যাসাগরের আসল নাম দয়ার সাগর।", a: "না", options: ["হ্যাঁ", "না"] },
                { q: "ওষুধ কিনে এনেছিলেন ডাক্তারবাবু নিজে।", a: "না", options: ["হ্যাঁ", "না"] },
                { q: "ধীরে ধীরে শিশুটি সেরে উঠল।", a: "হ্যাঁ", options: ["হ্যাঁ", "না"] },
                { q: "শিশুটি ছিল খুবই দুর্বল।", a: "না", options: ["হ্যাঁ", "না"] },
            ],
            word_meaning: [
                // Chapter-1: স্বাধীনতার সুখ (কবিতা)
                { q: "'খাসা' শব্দের অর্থ কী?", a: "পরিপাটি", options: ["পরিপাটি", "নোংরা", "সুন্দর", "খারাপ"] },
                { q: "'বড়াই' শব্দের অর্থ কী?", a: "অহংকার", options: ["অহংকার", "বিনয়", "লজ্জা", "রাগ"] },
                
                // Chapter-2: বোকামির ফল (গল্প)
                { q: "'উপায়' শব্দের অর্থ কী?", a: "কৌশল", options: ["কৌশল", "বিপদ", "রাস্তা", "নিয়ম"] },
                { q: "'পরিষ্কার' শব্দের অর্থ কী?", a: "নির্মল", options: ["নির্মল", "নোংরা", "ঘোলাটে", "কালো"] },
                { q: "'শীতল' শব্দের অর্থ কী?", a: "ঠান্ডা", options: ["ঠান্ডা", "গরম", "উষ্ণ", "হালকা"] },
                { q: "'উল্লাস' শব্দের অর্থ কী?", a: "আনন্দ", options: ["আনন্দ", "দুঃখ", "রাগ", "কান্না"] },
                { q: "'সর্বনাশ' শব্দের অর্থ কী?", a: "বিপদ", options: ["বিপদ", "ভালো", "লাভ", "আনন্দ"] },
                { q: "'কাণ্ড' শব্দের অর্থ কী?", a: "ঘটনা", options: ["ঘটনা", "ডাল", "পাতা", "মূল"] },
                
                // Chapter-3: প্রার্থনা (কবিতা)
                { q: "'প্রার্থনা' শব্দের অর্থ কী?", a: "আবেদন", options: ["আবেদন", "আদেশ", "নির্দেশ", "গল্প"] },
                { q: "'আদেশ' শব্দের অর্থ কী?", a: "হুকুম", options: ["হুকুম", "আবেদন", "অনুরোধ", "নিষেধ"] },
                { q: "'সামলিয়া' শব্দের অর্থ কী?", a: "সামলে", options: ["সামলে", "ফেলে", "দৌড়ে", "ঘুমিয়ে"] },
                { q: "'মোর' শব্দের অর্থ কী?", a: "আমার", options: ["আমার", "তোমার", "তার", "সবার"] },
                
                // Chapter-4: দয়ার সাগর (গল্প)
                { q: "'করুণা' শব্দের অর্থ কী?", a: "দয়া", options: ["দয়া", "নিষ্ঠুরতা", "রাগ", "অহংকার"] },
                { q: "'মারাত্মক' শব্দের অর্থ কী?", a: "সাংঘাতিক", options: ["সাংঘাতিক", "ভালো", "সুন্দর", "সাধারণ"] },
                { q: "'অগাধ' শব্দের অর্থ কী?", a: "গভীর", options: ["গভীর", "অগভীর", "হালকা", "কম"] },
                { q: "'ডাক্তার' শব্দের অর্থ কী?", a: "চিকিৎসক", options: ["চিকিৎসক", "শিক্ষক", "গায়ক", "চাষি"] },
                { q: "'কোলাহল' শব্দের অর্থ কী?", a: "হৈ চৈ", options: ["হৈ চৈ", "নিস্তব্ধ", "গান", "নাচ"] },
                { q: "'অনাথ' শব্দের অর্থ কী?", a: "যার কেউ নেই", options: ["যার কেউ নেই", "যার বাবা আছে", "যে খুব ধনী", "যে বোকা"] }
            ],
            opposite_word: [
                // Chapter-1: স্বাধীনতার সুখ (কবিতা)
                { q: "'গড়া'-র বিপরীত শব্দ কী?", a: "ভাঙা", options: ["ভাঙা", "তৈরি", "নষ্ট", "ঢাকা"] },
                { q: "'পাকা'-র বিপরীত শব্দ কী?", a: "কাঁচা", options: ["কাঁচা", "ভালো", "মন্দ", "শক্ত"] },
                { q: "'কষ্ট'-র বিপরীত শব্দ কী?", a: "আরাম", options: ["আরাম", "দুঃখ", "আনন্দ", "সুখ"] },
                
                // Chapter-2: বোকামির ফল (গল্প)
                { q: "'শীতল'-এর বিপরীত শব্দ কী?", a: "উষ্ণ", options: ["উষ্ণ", "ঠান্ডা", "গরম", "বরফ"] },
                { q: "'দেশে'-র বিপরীত শব্দ কী?", a: "বিদেশে", options: ["বিদেশে", "গ্রামে", "শহরে", "পথে"] },
                { q: "'শত্রু'-র বিপরীত শব্দ কী?", a: "মিত্র", options: ["মিত্র", "বন্ধু", "পর", "ভাই"] },
                { q: "'উপায়'-এর বিপরীত শব্দ কী?", a: "নিরুপায়", options: ["নিরুপায়", "কৌশল", "রাস্তা", "বিপদ"] },
                
                // Chapter-3: প্রার্থনা (কবিতা)
                { q: "'ভালো'-র বিপরীত শব্দ কী?", a: "মন্দ", options: ["মন্দ", "সুন্দর", "খারাপ", "খুশি"] },
                { q: "'সকাল'-এর বিপরীত শব্দ কী?", a: "সন্ধ্যা", options: ["সন্ধ্যা", "দুপুর", "বিকেল", "রাত"] },
                { q: "'সুখী'-র বিপরীত শব্দ কী?", a: "অসুখী", options: ["অসুখী", "আনন্দ", "কষ্ট", "দুঃখী"] },
                
                // Chapter-4: দয়ার সাগর (গল্প)
                { q: "'করুণা'-র বিপরীত শব্দ কী?", a: "নিষ্ঠুরতা", options: ["নিষ্ঠুরতা", "দয়া", "মায়া", "মমতা"] },
                { q: "'কোলাহল'-এর বিপরীত শব্দ কী?", a: "নিস্তব্ধ", options: ["নিস্তব্ধ", "হৈ চৈ", "শান্তি", "চুপ"] },
                { q: "'খোঁজ'-এর বিপরীত শব্দ কী?", a: "নিখোঁজ", options: ["নিখোঁজ", "পাওয়া", "দেখা", "হারা"] }
            ]
        }
    },
    "gk": {
